...
- [x] Clamp grid search: Config A/B/C çalıştır, en iyi EM/F1'i bul — step=20 (Config C) kazandı
- [x] MBR decoding (n=5) eklendi — sample_vqa_GPU.py, notebook N_SAMPLES=5
- [ ] MBR n=5 sampling çalıştır, EM/F1 karşılaştır (baseline: F1 %5.41 @ step=20)
